...
final class ActionsFileTests {
  ...
  // Test to make sure that the extended actions file is readable

    @Test
    void testExtendedActionsFileIsReadable() {
        try {
            DocumentBuilder builder = DocumentBuilderFactory.newInstance().newDocumentBuilder();
            ...
            fail("ParserConfigurationException was thrown when attempting to read extended actions file");
        } catch(SAXException saxe) {
